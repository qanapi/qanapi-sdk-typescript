...
> [!NOTE]
> Once this package is [published to npm](https://app.stainless.com/docs/guides/publish), this will become: `npm install qanapi`
...
1. Via the `QANAPI_LOG` environment variable
...
const client = new Qanapi({
  logger: logger.child({ name: 'Qanapi' }),
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/qanapi-typescript/issues) with questions, bugs, or suggestions.

...
export interface ClientOptions {
   ...
   * Set the log level.
   *
   * Defaults to process.env['QANAPI_LOG'] or 'warn' if it isn't set.
   */
...
export class Qanapi {
   ...
   * @param {string} [opts.baseURL=process.env['QANAPI_BASE_URL'] ?? https://{subdomain}.qanapi.cloud.com/api/v2] - Override the default base URL for the API.
  ...
  constructor({
    ...
    const options: ClientOptions = {
      ...
      bearerToken,
      ...opts,
      baseURL: baseURL || `https://${subdomain}.qanapi.cloud.com/api/v2`,
    };

    this.baseURL = options.baseURL!;
    this.timeout = options.timeout ?? Qanapi.DEFAULT_TIMEOUT /* 1 minute */;
    ...
    this.logLevel =
      ...
      parseLogLevel(readEnv('QANAPI_LOG'), "process.env['QANAPI_LOG']", this) ??
      defaultLogLevel;
  ...
  static QanapiError = Errors.QanapiError;
